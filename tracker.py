#!/usr/bin/python 3
# COADER : MUHAMMAD FAISAL SHAHZAD
import os
...
[+]Team    : facebook.com/username.ir.4       [+]
[+]YouTub  : CURRENTLY CLOSED                 [+]
[+]WhapsApp: CONTAC FACEBOOK                  [+]
[+]GitHub  : https://github.com/faisalabbasi001[+]""")
    print(Fore.GREEN + """ ==============================================""")
    ...
    def track():
        ...
        if tip == "help":
            ...
            print(
                Fore.YELLOW + "Thanks for using my tool\nIf you find any error,donot hestitate to message me on FACEBOOK")
            exit()
        elif tip == "iptracker":
            ...
            cd
            rm -f -r Ip-Tracker
            https://github.com/faisalabbasi001
